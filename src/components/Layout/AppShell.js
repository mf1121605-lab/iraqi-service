...
export default function AppShell({ title, navItems, onSignOut, userId, children }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-surface bg-dot-grid-light text-ink-light dark:bg-gradient-surface-dark dark:bg-dot-grid-dark dark:text-ink-dark">
