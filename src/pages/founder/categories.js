...
export default function FounderCategories() {
  ...
  return (
    <AppShell navItems={navItems} onSignOut={signOut} userId={profile.id}>
      <h2 className="font-display text-lg font-bold">{t('founderCategories.title')}</h2>
      ...
      >
        ...
        <button
          type="submit"
          className="sm:col-span-3 rounded-xl2 bg-brand-600 px-4 py-2 text-sm font-semibold text-white hover:bg-brand-700"
        >
