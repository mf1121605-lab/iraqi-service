  ...
  return (
    <AppShell navItems={navItems} onSignOut={signOut} userId={profile.id}>
      ...
      <form onSubmit={handleCreate} className="mt-6 grid gap-3 sm:grid-cols-2">
        <input aria-label={t('founderEmployees.phoneLabel')} placeholder={t('founderEmployees.phoneLabel')} value={form.phone} onChange={(e) => setForm({ ...form, phone: e.target.value })} className="rounded-xl2 border border-black/10 bg-white px-3 py-2 text-sm dark:border-white/10 dark:bg-surface-dark" />
        <input aria-label={t('founderEmployees.emailLabel')} placeholder={t('founderEmployees.emailLabel')} value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })} className="rounded-xl2 border border-black/10 bg-white px-3 py-2 text-sm dark:border-white/10 dark:bg-surface-dark" />
        <input aria-label={t('founderEmployees.passwordLabel')} type="password" placeholder={t('founderEmployees.passwordLabel')} value={form.password} onChange={(e) => setForm({ ...form, password: e.target.value })} className="rounded-xl2 border border-black/10 bg-white px-3 py-2 text-sm dark:border-white/10 dark:bg-surface-dark" />
        <input aria-label={t('founderEmployees.givenNameLabel')} placeholder={t('founderEmployees.givenNameLabel')} value={form.givenName} onChange={(e) => setForm({ ...form, givenName: e.target.value })} className="rounded-xl2 border border-black/10 bg-white px-3 py-2 text-sm dark:border-white/10 dark:bg-surface-dark" />
        <input aria-label={t('founderEmployees.fatherNameLabel')} placeholder={t('founderEmployees.fatherNameLabel')} value={form.fatherName} onChange={(e) => setForm({ ...form, fatherName: e.target.value })} className="rounded-xl2 border border-black/10 bg-white px-3 py-2 text-sm dark:border-white/10 dark:bg-surface-dark" />
        <input aria-label={t('founderEmployees.grandfatherNameLabel')} placeholder={t('founderEmployees.grandfatherNameLabel')} value={form.grandfatherName} onChange={(e) => setForm({ ...form, grandfatherName: e.target.value })} className="rounded-xl2 border border-black/10 bg-white px-3 py-2 text-sm dark:border-white/10 dark:bg-surface-dark" />
        <input aria-label={t('founderEmployees.familyNameLabel')} placeholder={t('founderEmployees.familyNameLabel')} value={form.familyName} onChange={(e) => setForm({ ...form, familyName: e.target.value })} className="rounded-xl2 border border-black/10 bg-white px-3 py-2 text-sm dark:border-white/10 dark:bg-surface-dark" />
        <input aria-label={t('founderEmployees.specializationLabel')} placeholder={t('founderEmployees.specializationLabel')} value={form.specialization} onChange={(e) => setForm({ ...form, specialization: e.target.value })} className="rounded-xl2 border border-black/10 bg-white px-3 py-2 text-sm dark:border-white/10 dark:bg-surface-dark" />
