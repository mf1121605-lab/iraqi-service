  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        // Layered, multi-stop shadows for a subtle sense of physical depth —
        // a single soft shadow reads flat; two or three stacked at different
        // spreads/opacities is what most "premium" UI shadows actually are.
        elevate:
  ...
  plugins: [
    ...
    function ({ addComponents }) {
      addComponents({
        ...
        // Frosted, translucent chrome for sticky headers/nav bars — lighter
        // blur than the panel variants so text underneath stays legible
        // while scrolling behind it.
        '.glass-nav': {
